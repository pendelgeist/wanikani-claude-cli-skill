...
export const ANSWER_CONVENTION =
  ...
  "Say \"more\" after any item for its mnemonic and parts.";
...
export function batchSummaryLine({
  ...
  // A tip rides *inside* the line rather than beside it, for the same reason
  // the lookup link does: an adjacent field is an optional field, and optional
  // fields don't get printed. It goes on its own line so it can't be mistaken

...
// "fur, ke" · "fur / ke" · "fur、ke" · "to realize. kidzuku" — whichever
// separator came to hand. A full stop only counts with a space after it, so
// it can't cut a decimal or an abbreviation in half.
const EXPLICIT_SEPARATORS = /\s*[,、;/]\s*|\.\s+/;

 ...
 * goes to stderr, because it isn't part of the session. It repeats on every
 * new batch because a sitting outlives a conversation: a fresh session picking
 * one up mid-way is handed a question and, without this, no idea which command
 * turns a reply into a record.
 *

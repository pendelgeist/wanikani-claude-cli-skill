...
export const TIPS = [
  ...
  'Ask "did that go through?" or "what\'s left?" any time — it reads the record rather than counting back through the chat.',
  'Say "drill my recent mistakes" for a run at the items you last got wrong — same grading, nothing submitted.',
  'Say "critical items" for the ones WaniKani has you under 75% on — its own critical-condition list, worst first, and the same terms as a drill.',
